...
def get_number_of_days(file_name):
...
def calculate_missing_days(yield_files, args):
    ...
    for yfile in yield_files:
        ...
        days = get_number_of_days(yfile)            #get the number of days according to the given condition
...
def main():
    ...
    calculate_missing_days(yield_files, args)
    return 
