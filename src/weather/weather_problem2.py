...
def get_consolidated_data_frame(station_file):
...
def calculate_aggregated_data(yield_files, args):

    for station_file in yield_files:
        df = get_consolidated_data_frame(station_file)      #get consolidated data frame after grouping and aggregating
...
def main():
    ...
    calculate_aggregated_data(yield_files, args)    #get the aggregated data and store it in output file
